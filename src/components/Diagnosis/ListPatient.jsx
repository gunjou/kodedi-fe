  ...
  return (
    <div className="ListPatient">
			...
			<div className="bg-purple-600 rounded-xl">
				<div className="grid grid-cols-10 p-2 text-white font-bold">
					...
					<span className="col-span-1 text-center">Umur</span>
					<span className="col-span-1 text-center">Status</span>
				</div>
				<div className="p-2 bg-white rounded-xl text-black text-sm">
					{list.map((row, i) =>
						<div className="grid pb-1 grid-cols-10 text-sm hover:bg-purple-400 rounded-xl pt-1">
							<span className='col-span-1 text-center'>{i+1}</span>
							<span className='col-span-2 text-center'>{row.no_cm}</span>
							<span className='col-span-4'>{row.fullname}</span>
							<span className='col-span-1 text-center'>{row.gender}</span>
							<span className='col-span-1 text-center'>{row.age} Tahun</span>
